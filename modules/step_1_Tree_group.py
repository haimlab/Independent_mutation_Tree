...
def recursive_tree_search(input_tree,max_group_size,glob):
    ...
    if count_nodes(input_tree) < max_group_size:
        ...
        print(count_nodes(input_tree)) #print out file name
    ...
    if recursive:
        descendants = input_tree.descendants
        for nodes in descendants:
            recursive_tree_search(nodes,max_group_size,glob) # Recursively prune each descendant tree
...
if __name__ == '__main__':
    ...
    recursive_tree_search(tree_search,max_group_size,glob)